    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 text">
                ...
                <ul>
                    <li>High efficiency, environmental protection, upto 30,000 hours of service
                        life</li>
                ...
                is required such as :-</p>

                Dentists and Hospital rooms<br>
                Shops<br>
                Nightclubs and casinos<br>
                Reception areas<br> 
                Classrooms<br> 
                Spa and fitness clubs<br> 
                Spaces without natural light sources.<br>
                Company Boardrooms<br>
                Restaurants<br>
            </div>
